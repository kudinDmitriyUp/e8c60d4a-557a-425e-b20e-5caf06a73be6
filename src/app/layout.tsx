...
export const metadata: Metadata = {
  title: "Marketing Pro | Digital Marketing Agency",
  description: "Elevate your brand with data-driven marketing strategies. Social media, SEO, content, and brand strategy services that deliver measurable results.",
  keywords: "marketing agency, digital marketing, social media marketing, SEO services, brand strategy, content marketing",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765907059444-8i3ihqyf.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765907059444-8i3ihqyf.jpg"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Marketing Pro | Digital Marketing Agency",
    description: "Transform your brand with proven marketing strategies and creative campaigns.",
    type: "website",
    siteName: "Marketing Pro",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765907059444-8i3ihqyf.jpg",
      alt: "Marketing Pro - Digital Marketing Services"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Marketing Pro | Digital Marketing Agency",
    description: "Data-driven strategies. Creative campaigns. Measurable results.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765907059444-8i3ihqyf.jpg"]
  }
};
